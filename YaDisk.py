...
class YaUploader:
    ...
    def delete_folder(self, YaDisk_folder):
        params = {'path' : YaDisk_folder}
        headers = {'Authorization' : self.token}
        resp = requests.delete('https://cloud-api.yandex.net/v1/disk/resources', params=params, headers=headers)
        resp.raise_for_status()
        return resp
    
    def return_meta(self, YaDisk_folder):
        params = {'path' : YaDisk_folder}
        headers = {'Authorization' : self.token}
        resp = requests.get('https://cloud-api.yandex.net/v1/disk/resources', params=params, headers=headers)
        resp.raise_for_status()
        return resp
